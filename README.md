...
A modular Python pipeline for multi-analyte biomarker case–control studies. Handles multi-sheet Excel data, clinical metadata, and produces publication-ready statistical analyses and visualisations.
